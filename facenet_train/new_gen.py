...
for i_img in range(num_imgs):
    ...
    for i_object in range(num_objects):
        ...
        # if color == 0:
        #     fill(255 - max_offset + r_offset,
        #          0 + g_offset, 0 + b_offset, alpha)
        # elif color == 1:
        #     fill(0 + r_offset, 255 - max_offset +
        #          g_offset, 0 + b_offset, alpha)
    ...
    save(
        './{}/{}_{}.png'.format(shape_labels[shape], i_img, color_labels[color]))

file = createWriter("./dataset.txt")
