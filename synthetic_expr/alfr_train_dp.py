...
laftr_adv_criterion = AdvDemographicParityLoss(args.p)
...
#         print('-'*80)
        ...
        cls_loss, cls_en_acc, adv_loss, adv_acc, cls_en_combinedLoss, adv_combinedLoss = alfr_train_dp(laftrtrain_loader,
