...
python openface_train.py -j semi_std_cos4 -e 60 --semi-hard --num-classes 15 --num-samples 20 --cosine -r -rw /home/s1791387/facescrub-data/new_data_max/openface_model_weigths/job_semi_std_cos3_Jul_25_1000hrs/weights_75.pth
